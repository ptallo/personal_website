...
export function Navbar() {
  ...
  return <div className='navbar'>
    ...
    <div className='flex-container'>
      ...
      <div className='to-hide' onClick={(_) => { scrollToClass('skills') }}>Skills</div>
      <div className='to-hide' onClick={(_) => { scrollToClass('employment-history') }}>Employment</div>
      <div className='to-hide' onClick={(_) => { scrollToClass('contact-me') }}>Contact Me</div>
